...
def windows_tools():
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     Windows Tools     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
    print("                                  选择一个选项awa         输入Q以退出")
    print("1.打开终端     2.打开注册表    3.打开计算器    4.打开资源管理器      5.一键重启    6.一键关机")
    print("7.打开power shell")
    print("")
    print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
...
def small_blue():
    os.system("taskkill /f /fi " + f"{taskkill_ne}")
...
baibaoxiangliebiao = ['1','2','3','4','5','6','q','Q']
fastbreakwindowslist = ['1','2','q','Q']
wenjianfensuijiliebiao = ['1','2','3','4','q','Q']
windowstoolsliebiao = ['1','2','3','4','5','6','7','q','Q']
...
while active:
    ...
    if xuanxiang not in xuanxianglist:
        ...
        windows_tools()
        while active_windowstools:
            windowstoolsliebiao = input("请输入选项:")
            if windowstoolsliebiao not in windowstoolsliebiao:
                print("您输入的选项无效，请重新输入qwq")
            elif windowstoolsliebiao =='q':
                active_windowstools = False
            elif windowstoolsliebiao =='Q':
                active_windowstools = False
            elif windowstoolsliebiao =='1':
                os.system("start cmd.exe")
            elif windowstoolsliebiao =='2':
                os.system("start regedit.exe")
            elif windowstoolsliebiao =='3':
                os.system("start calc.exe")
            elif windowstoolsliebiao =='4':
                os.system("start explorer.exe")
            elif windowstoolsliebiao =='5':
                os.system("shutdown -r -t 0")
            elif windowstoolsliebiao =='6':
                os.system("shutdown -s -t 0")
            elif windowstoolsliebiao =='7':
